...
<html lang="pt-BR">
    <head>
        ...
        <title>Meu Malvado Favorito 4</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row"> 
                <div class="col-md-6"> 
                    <img src="Assets/MeuMalvadoFavorito4.jpg" class="cartaz img-fluid">
                    <h2>Meu Malvado Favorito 4</h2>
                    <h3> Gru dá as boas-vindas a um novo membro da família, Gru Jr., que pretende atormentar seu pai. 
                        No entanto, sua existência pacífica logo desmorona quando um mentor
                        do crime escapa da prisão e jura vingança contra Gru.
                    </l>
                </div>


            <div class="col-md-6">
                <form action="movie1.php" method="POST" class="custom-form-border">
                <div class="mb-3"> <!-- Direita -->
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['submit'])) {
        ...
        $result = mysqli_query($conexao, "INSERT INTO room1(nome, cpf, data_nasc, email) VALUES ('$nome', '$cpf', '$data_nasc', '$email')");
