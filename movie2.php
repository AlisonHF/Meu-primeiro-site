...
<html lang="pt-BR">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6"> 
                    <img src="Assets/Deadpoolewolverine.jpg" class="cartaz img-fluid">
                    <h2>Deadpool e Wolverine</h2>
                    <h3> Wolverine está se recuperando quando cruza seu caminho com Deadpool.
            ...
            <div class="col-md-6">
                <form action="movie2.php" method="POST" class="custom-form-border">
                <div class="mb-3">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['submit'])) {
        ...
        $result = mysqli_query($conexao, "INSERT INTO room2(nome, cpf, data_nasc, email) VALUES ('$nome', '$cpf', '$data_nasc', '$email')");
    } 
}
?>
